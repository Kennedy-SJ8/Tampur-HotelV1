...
const traducciones = {
  ES: {
    ...
    franja_checkout: 'Check-out 12:00 p.m.', franja_tipos: 'Simple · Doble · Matrimonial',
    ...
    habitacion_simple: 'Habitación Simple', habitacion_doble: 'Habitación Doble',
    ...
    doble_1: '2 camas individuales', doble_2: 'Baño privado con agua caliente',
    doble_3: 'Wi-Fi + TV por cable', doble_4: 'Ideal para familias',
    mat_1: '1 cama queen', mat_2: 'Baño privado con agua caliente',
    mat_3: 'Wi-Fi + TV + balcón', mat_4: 'Las mejores vistas',
    ...
    pago_numero: 'O envíe a este número', pago_yapeplin: 'Yape / Plin',
    pago_subir: 'Subir comprobante de pago', pago_nombre_arch: 'Ningún archivo seleccionado',
  ...
  EN: {
    ...
    franja_checkout: 'Check-out 12:00 p.m.', franja_tipos: 'Single · Double · Matrimonial',
    ...
    habitacion_simple: 'Single Room', habitacion_doble: 'Double Room',
    habitacion_matrimonial: 'Matrimonial Room',
    simple_1: '1 single bed', simple_2: 'Private bathroom with hot water',
    simple_3: 'High-speed Wi-Fi', simple_4: 'Mountain views',
    doble_1: '2 single beds', doble_2: 'Private bathroom with hot water',
    doble_3: 'Wi-Fi + Cable TV', doble_4: 'Ideal for families',
    mat_1: '1 queen bed', mat_2: 'Private bathroom with hot water',
    mat_3: 'Wi-Fi + TV + balcony', mat_4: 'Best views',
    btn_reservar: 'Book',
    // Amenidades
    ...
    pago_numero: 'Or send to this number', pago_yapeplin: 'Yape / Plin',
